        ...
        <div class="content">
            <header class="header center">
                <div class="header__left">
                    <a href="index.php"><img src="img/store/logo.svg" alt="logo"></a>
                    <a class="header__search" href="#"><img src="img/store/search.svg" alt="search"></a>
                </div>
                <div class="header__right">
                    ...
                    <nav class="nav">
                        ...
                        <ul class="nav__list">
                            <li class="nav__li"><a class="nav__link" href="catalog.php">Accessories</a></li>
                            <li class="nav__li"><a class="nav__link" href="catalog.php">Bags</a></li>
                            <li class="nav__li"><a class="nav__link" href="catalog.php">Denim</a></li>
                            <li class="nav__li"><a class="nav__link" href="catalog.php">T-Shirts</a></li>
                        </ul>

                        <h4 class="nav__menu">Woman</h4>
                        <ul class="nav__list">
                            <li class="nav__li"><a class="nav__link" href="catalog.php">Accessories</a></li>
                            <li class="nav__li"><a class="nav__link" href="catalog.php">Jackets & Coats</a></li>
                            <li class="nav__li"><a class="nav__link" href="catalog.php">Polos</a></li>
                            <li class="nav__li"><a class="nav__link" href="catalog.php">T-Shirts</a></li>
                            <li class="nav__li"><a class="nav__link" href="catalog.php">Shirts</a></li>
                        </ul>
                    ...
                    <p class="header__icons"><label for="switcher"><img src="img/store/menu.svg" alt="menu"></label>
                    </p>
                    <div class="header__links">
                        <a class="header__icons" href="#"><img src="img/store/account.svg" alt="account"></a>
                        <a class="header__icons" href="#"><img src="img/store/cart.svg" alt="cart"></a>
                    </div>
                </div>
            </header>
            ...
            <section class="products center">
                <div class="details__filter">
                    ...
                    <div class="filter filter_mobile">
                        <details class="filter__main">
                            <summary class="filter__name"><svg width="38" height="25" viewBox="0 0 38 25" fill="none"
                ...
                <?php
                    ...
                    <div class="products__card">
                        <a href="product.php?id=<?= $data['id'] ?>"><img class="card__image" src="img/store/goods/<?= $data['img'] ?>" alt="product image"></a>
                        <a href="product.php?id=<?= $data['id'] ?>">
                            <h3 class="card__h3"><?= $data['name'] ?></h3>
                        </a>
                        <p class="card__text"><?= $data['description'] ?></p>
                        <p class="card__price">$<?= $data['price'] ?>.00</p>
                        <a href="#" class="product__add"><svg class="product__cart" width="27" height="25"
                    ...
                    <?php } ?>
<!--                    <div class="products__card">-->
<!--                        <a href="product.html"><img class="card__image" src="img/product_1.jpg" alt="product image"></a>-->
<!--                        <a href="product.html">-->
<!--                            <h3 class="card__h3">Lorem, ipsum dolor.</h3>-->
<!--                        </a>-->
<!--                        <p class="card__text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis at facere,-->
<!--                            consequuntur error a corrupti enim magni quae iure sit provident, molestiae quia totam sunt-->
<!--                            consequatur dicta! Fugiat, voluptas quidem?</p>-->
...
<!--                    </div>-->
        ...
        <footer class="footer">
            <section class="footer__advantages center">
                <div class="advantages__item"><svg width="46" height="32" viewBox="0 0 46 32" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path
            ...
            <div class="footer__review center">
                ...
                <div class="footer__form">
                    <h3 class="form__h3">SUBSCRIBE</h3>
            ...
            <div class="footer__bottom center">
                ...
                <div class="smm">
                    <a class="smm__link" href="https://www.facebook.com/" target="_blank"><svg class="smm_icon"
                    ...
                    <a class="smm__link" href="https://www.instagram.com/" target="_blank"><svg class="smm_icon"
                    ...
                    <a class="smm__link" href="https://www.pinterest.ru/" target="_blank"><svg class="smm_icon"
                    ...
                    <a class="smm__link" href="https://twitter.com/" target="_blank"><svg class="smm_icon" width="17"
                            height="14" viewBox="0 0 17 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
