        ...
        <div class="content">
            <header class="header center">
                ...
                <div class="header__right">
                    ...
                    <p class="header__icons"><label for="switcher"><img src="img/menu.svg" alt="menu"></label>
                    </p>
                    <div class="header__links">
                        <a class="header__icons" href="registration.php"><img src="img/account.svg" alt="account"></a>
                        <a class="header__icons" href="cart.php"><img src="img/cart.svg" alt="cart"><img id="circle" class="cart__circle" <?php if ($_SESSION['cart_empty'] == 1){echo 'style="display: block"';} ?> src="img/white_circle.png" alt="#"></a>
                    </div>
                </div>
            </header>
            ...
            <section class="products center">
                ...
                <?php
                    ...
                    <div class="products__card">
                        <a href="product.php?id=<?= $item['id'] ?>"><img class="card__image" src="img/product_img/<?= $item['img'] ?>" alt="product image"></a>
                        <a href="product.php?id=<?= $item['id'] ?>">
                            <h3 class="card__h3"><?= $item['name'] ?></h3>
                        </a>
                        <p class="card__text"><?= $item['description'] ?></p>
                        <p class="card__price">$<?= $item['price'] ?>.00</p>
                        <button onclick="item(<?= $item['id'] ?>)" class="product__add"><svg class="product__cart" width="27" height="25"
